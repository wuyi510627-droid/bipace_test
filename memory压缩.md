...
| 指标 | 定义 | 为什么需要 |
|---|---|---|
| 关键步排名 | $\lvert A_{\text{key}}\rvert$ 在所有步里排第几；1 = 理想 | 直观，但会饱和 |
| **信用集中度** | $\lvert A_{\text{key}}\rvert\big/\sum_t \lvert A_t\rvert$ | 不饱和，主指标 |
| **margin** | $\lvert A_{\text{key}}\rvert-\max_{t\neq\text{key}}\lvert A_t\rvert$ | 分得干不干脆 |
